...
int RendererWindows::findUniformIndex( const unsigned int shaderProgram, const char* pUniformName ) const {
	int a = shaderProgram;
	char name = pUniformName[0];
	name = name;
	a = a;
...
void RendererWindows::setFloat( const float value, const unsigned int uniformIndex ) const {
	float a = value;
	unsigned int b = uniformIndex;
	a = a;
	b = b;
}

void RendererWindows::setInt( const int value, const unsigned int uniformIndex ) const {
	int a = value;
	unsigned int b = uniformIndex;
	a = a;
	b = b;
...
void RendererWindows::setMat4( const Mat4& rValue, const unsigned int uniformIndex ) const {
	Mat4 mat = rValue;
	mat = mat;
	int a = 5 + uniformIndex;
	a = a;
}
...
void RendererWindows::render( Scene* pScene, const bool clear ) const {
	...
	auto pModel = pScene->getOpaqueModels().mpFirstNode;
	while(pModel) {
